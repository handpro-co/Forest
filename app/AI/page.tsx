...
const AI: React.FC = () => {
  ...
  useEffect(() => {
    const handleKeyPress = (event: KeyboardEvent) => {
      // Prevent triggering if a video is already playing
  ...
  }, [isVideoPlaying]); // Add isVideoPlaying as a dependency
  ...
  const playVideo = (
    ...
    video.onended = () => {
      setText("Таны асуултад хариуллаа. Танд өөр асуулт байна уу?");
  ...
  return (
    <div className="flex items-start justify-start h-screen">
      ...
      <div className="w-[35%] h-screen overflow-auto p-4 flex flex-col items-center  ">
        ...
        <div className="relative w-full h-[70%] rounded-[24px] bg-white py-[50px]">
          <div
